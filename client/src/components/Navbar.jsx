  ...
  return (
    <div className="bg-white shadow z-50 sticky top-0">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <Link to="/">
          <img src={logo} alt="TNQ Store Logo" className="h-15 w-40 object-contain" />
        </Link>
                    ...
                    <div key={i} className="mr-8">
                      ...
                      <ul>
                        {col.items.map((subItem, j) => (
                          <li key={j} className="hover:text-red-500">{subItem}</li>
                        ))}
                      </ul>
                    </div>
                  ))}
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <img
              src={searchIcon}
              alt="Search"
              className="h-5 w-5 absolute left-2 top-2"
            />
          </div>
