  ...
  const handleAddToCart = () => {
    if (product && selectedColor) {
      const cartItem = {
        ...
        giaTienSo: Number.parseInt(String(product.giaTien).replace(/\D/g, "")),
          ...
          <div className="md:w-1/2">
            {selectedColor && selectedColor.hinhAnh?.length > 0 ? (
                  ...
                  {selectedColor.hinhAnh.map((img, index) => (
                    <SwiperSlide key={img.id || `main-${index}`}>
                      <img
                        ...
                        className="w-full h-[600px] object-contain md:object-cover rounded-lg"
                      />
                    </SwiperSlide>
                  ))}
                </Swiper>
              ...
              <img
                ...
                className="w-full h-[600px] object-contain md:object-cover rounded-lg border"
              />
            )}
          </div>
          ...
          <div className="md:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <button 
                ...
                disabled={!selectedColor && product.mauSac?.length > 0}
              >
                THÊM VÀO GIỎ HÀNG
              </button>
