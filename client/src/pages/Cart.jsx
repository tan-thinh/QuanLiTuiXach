    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center gap-2 mb-6">
          <img src="/assets/shopping-bag.png" alt="Giỏ hàng" className="h-6 w-6" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="grid grid-cols-12 gap-2 items-center">
                        ...
                        <div className="col-span-11 md:col-span-5">
                          <div className="flex gap-3">
                            ...
                            <div>
                              ...
                              >
                                <img src="/assets/trash.png" alt="Xóa" className="h-4 w-4" />
                        ...
                        <div className="col-span-6 md:col-span-2">
                          <div className="flex items-center justify-center">
                            ...
                            >
                              <img src="/assets/minus.png" alt="Giảm" className="h-3 w-3" />
                            </button>
                            <input
                              type="text"
                              value={item.soLuong}
                            ...
                            >
                              <img src="/assets/plus.png" alt="Tăng" className="h-3 w-3" />
                            </button>
                          </div>
                        </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-sm p-4 sticky top-4">
                ...
                <Link
                  to="/checkout"
                  className={`block w-full py-3 mb-3 rounded font-medium text-center ${hasSelectedItems ? "bg-red-600 hover:bg-red-700 text-white" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`}
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex gap-2 items-center text-sm">
                    <img src="/assets/truck.png" alt="Giao hàng" className="h-5 w-5" />
                    <div>
                  ...
                  <div className="flex gap-2 items-center text-sm">
                    <img src="/assets/exchange.png" alt="Đổi trả" className="h-5 w-5" />
                    <div>
                  ...
                  <div className="flex gap-2 items-center text-sm">
                    <img src="/assets/phone.png" alt="Tổng đài" className="h-5 w-5" />
                    <div>
